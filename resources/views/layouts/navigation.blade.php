        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center space-x-6">
                ...
                <div class="relative hidden sm:block">
                    <button onclick="toggleDropdown()" class="relative text-gray-600 dark:text-gray-300 focus:outline-none mx-4">
                        🔔
                    ...
                    <div id="notificationDropdown" class="absolute right-0 mt-2 bg-white dark:bg-gray-800 shadow-md w-64 hidden rounded-lg border border-gray-300 dark:border-gray-700">
                        ...
                        <div class="max-h-64 overflow-y-auto rounded-lg shadow-sm bg-white dark:bg-gray-800">
                            @forelse (Auth::user()->unreadNotifications as $notification)
                                <a href="{{ route('notifications.read', $notification->id) }}" class="block px-4 py-3 text-sm text-gray-800 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="p-2 rounded-md text-gray-400 dark:text-gray-500 hover:text-gray-500 dark:hover:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-900 focus:outline-none">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="border-t border-gray-200 dark:border-gray-600 pt-3">
            ...
            <div class="px-4 max-h-64 overflow-y-auto">
                @forelse (Auth::user()->unreadNotifications as $notification)
                    <a href="{{ route('notifications.read', $notification->id) }}" class="block py-2 text-sm text-gray-800 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700">
                        {{ $notification->data['message'] }}
                    </a>
                @empty
