        ...
        <div class="max-w-4xl mx-auto px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6">
                ...
                <div class="mb-6 bg-cover bg-center rounded-lg h-36 flex items-center justify-center" style="background-image: url('https://i.gifer.com/76YS.gif');">
                    <h3 class="text-white text-2xl font-bold bg-black bg-opacity-50 px-4 py-2 rounded-lg">Atur Budget Anda</h3>
                </div>
                ...
                <form action="{{ route('budgets.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <select name="category_id" required 
                            ...
                            @else
                                <option value="" disabled selected>🔍 Pilih kategori budget...</option>
