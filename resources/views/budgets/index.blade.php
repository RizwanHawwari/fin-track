        ...
        <div id="budgetModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden px-4">
            <div
                ...
                <p class="mt-3 md:mt-5 text-gray-700 dark:text-gray-300 text-sm md:text-base leading-relaxed">
                    Dengan fitur budgeting, kamu bisa <strong>mengatur batas pengeluaran</strong> untuk setiap kategori
                    keuangan.
                </p>
                ...
                <div
                    ...
                    Jika budget hampir habis, kamu akan mendapatkan <strong
                        class="text-indigo-700 dark:text-indigo-300">notifikasi khusus</strong>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-6">
                @foreach ($budgets as $budget)
                    ...
                    @endphp
                    <div
                        class="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 group">
                        <div class="flex justify-between items-start mb-4">
                            <h4
                                class="text-lg font-bold text-gray-800 dark:text-gray-100 transition-colors group-hover:text-indigo-600">
                        ...
                        <div class="mb-4">
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400">
                                Rp {{ number_format($budget->spent, 0, ',', '.') }} / Rp
                        ...
                        <!-- Actions -->
                        <div
                            class="flex justify-between items-center border-t border-gray-100 dark:border-gray-700 pt-4 mt-4">
                            ...
                            <form id="delete-form-{{ $budget->id }}"
                                action="{{ route('budgets.destroy', $budget->id) }}" method="POST" class="hidden">
                                @csrf
                                @method('DELETE')
                            </form>
                        </div>
