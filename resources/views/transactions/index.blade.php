                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-3">
                        ...
                        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                            ...
                            Gunakan fitur ini untuk melacak transaksi secara rinci dan melihat histori keuanganmu kapan
                            saja!
                        </p>
        ...
        <div id="transactionModal"
            ...
            <div
                ...
                <p class="mt-3 md:mt-5 text-gray-700 dark:text-gray-300 text-sm md:text-base leading-relaxed">
                    Dengan fitur <strong>Transactions</strong>, kamu bisa mencatat setiap pemasukan dan pengeluaran
                    keuanganmu.
                    Semua transaksi akan tersimpan dalam sistem dan bisa diakses kapan saja untuk membantu mengelola
                    keuangan lebih baik.
                </p>
                ...
                <div
                    ...
                    Dengan fitur ini, kamu dapat <strong class="text-blue-700 dark:text-blue-300">melacak setiap
                        pengeluaran</strong>
