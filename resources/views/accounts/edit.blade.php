        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6">
                ...
                <h3 class="text-lg font-semibold dark:text-gray-200 mb-4">
                    {{ isset($account) ? 'Edit Akun' : 'Tambah Akun' }}</h3>
                ...
                <form action="{{ isset($account) ? route('accounts.update', $account->id) : route('accounts.store') }}"
                    ...
                    <div class="mb-4">
                        <label for="balance" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Saldo
                            Awal</label>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="type" id="type" required
                            ...
                            <option value="e-wallet"
                                {{ old('type', $account->type ?? '') == 'e-wallet' ? 'selected' : '' }}>E-Wallet
                            </option>
