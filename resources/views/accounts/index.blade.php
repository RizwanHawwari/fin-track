                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-3">
                        ...
                        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                            Akun Keuangan membantumu mengatur saldo di berbagai tempat seperti bank, dompet digital,
                            atau uang tunai.
        ...
        <div id="accountModal"
            ...
            <div
                ...
                <p class="mt-3 md:mt-5 text-gray-700 dark:text-gray-300 text-sm md:text-base leading-relaxed">
                    Dengan fitur <strong>Akun Keuangan</strong>, kamu bisa <strong>menambahkan akun secara
                        manual</strong> seperti
                ...
                <p class="mt-3 md:mt-4 text-gray-700 dark:text-gray-300 text-sm md:text-base leading-relaxed">
                    Setiap akun memiliki <strong>nama, saldo, dan tipe akun</strong> (misalnya "DANA", "BCA", atau
                    "Tunai"),
                ...
                <div
                    ...
                    Demi <strong>keamanan dan privasi</strong>, aplikasi ini <strong>tidak terhubung langsung ke
                        rekening bank atau dompet digital</strong>.
                    Semua saldo <strong>diinput manual oleh pengguna</strong> untuk memberikan kendali penuh atas
                    ...
                    <table class="w-full">
                        <thead>
                            <tr
                                ...
                                <th class="px-6 py-3 border-b border-gray-100 dark:border-gray-700 text-center">Aksi
                                </th>
                            </tr>
                        </thead>
